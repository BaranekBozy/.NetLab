...
namespace Wypozyczalnia_sprzetu_budowlanego.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(baza_sprzetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCustomer,Imie,Nazwisko,NumerTel,Email")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCustomer,Imie,Nazwisko,NumerTel,Email")] Customer customer)
        {
