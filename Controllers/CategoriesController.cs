...
namespace Wypozyczalnia_sprzetu_budowlanego.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(baza_sprzetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCategory,NazwaKategorii")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCategory,NazwaKategorii")] Category category)
        {
